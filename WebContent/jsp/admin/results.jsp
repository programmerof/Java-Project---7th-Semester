...
<div class="main">
    <div class="page-header">
        <h1>All Results</h1>
        <p>View every student's exam submissions.</p>
    </div>
    <%
    ...
    <div class="card">
        ...
        <% if (results == null || results.isEmpty()) { %>
            <p style="color:var(--muted); padding:1rem 0;">No results yet.</p>
        <% } else { %>
        <table>
            <thead><tr><th>Student</th><th>Exam</th><th>Score</th><th>Grade</th><th>Submitted</th><th>Action</th></tr></thead>
            <tbody>
            <% for (Result r : results) { %>
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath}/admin/results?resultId=<%= r.getId() %>" class="btn btn-sm btn-success">Review</a></td>
                </tr>
            <% } %>
            </tbody>
        </table>
