...
<title>Create Exam — ExamPortal</title>
...
<div class="main">
    <div class="page-header">
        ...
        <p>Set up a new exam — you can add questions after creating it.</p>
    </div>
    ...
    <div class="card" style="max-width:600px">
        <form method="post" action="${pageContext.request.contextPath}/admin/create-exam">
            <div class="form-group">
                <label for="title">Exam Title *</label>
                <input type="text" id="title" name="title" placeholder="e.g. Java Fundamentals Quiz" required>
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <textarea id="description" name="description" placeholder="Brief description of what this exam covers..."></textarea>
            </div>
            <div class="form-group">
                <label for="durationMins">Duration (minutes) *</label>
                <input type="number" id="durationMins" name="durationMins" value="30" min="1" max="300" required>
            </div>
            <div style="display:flex; gap:0.75rem; margin-top:1.25rem;">
                <button type="submit" class="btn btn-primary">Create Exam &amp; Add Questions &#8594;</button>
                <a href="${pageContext.request.contextPath}/admin/dashboard" class="btn btn-danger">Cancel</a>
            </div>
        </form>
    </div>
</div>
