...
<title>Result Detail — ExamPortal</title>
...
<div class="main">
    <%
        ...
        if (result == null) { response.sendRedirect(request.getContextPath() + "/admin/results"); return; }
    %>
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
        <div class="page-header" style="margin:0">
            <h1><%= result.getExamTitle() %></h1>
            <p>Student: <strong><%= result.getStudentName() %></strong> &nbsp;|&nbsp; Submitted: <%= result.getSubmittedAt() %></p>
        </div>
        <a href="${pageContext.request.contextPath}/admin/results" class="btn btn-danger btn-sm">&#8592; Back</a>
    </div>
