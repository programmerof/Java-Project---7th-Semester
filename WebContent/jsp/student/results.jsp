...
<%@ page import="java.util.List, model.Result" %>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main">
    <div class="page-header">
        <h1>My Results</h1>
        <p>All your exam submissions and scores.</p>
    </div>
    ...
    <% if (results == null || results.isEmpty()) { %>
        <div class="card" style="text-align:center; padding:2.5rem; color:var(--muted);">
            ...
            <br><br><a href="${pageContext.request.contextPath}/student/dashboard" class="btn btn-primary">Browse Exams</a>
        </div>
    <% } else { %>
    <div class="card">
        <div class="table-wrap">
        <table>
            <thead><tr><th>Exam</th><th>Score</th><th>%</th><th>Grade</th><th>Date</th><th></th></tr></thead>
            <tbody>
